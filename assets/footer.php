<?php ?>
    ...
    <!-- ***** CTA Area Start ***** -->
    <section class="our-monthly-membership section_padding_50 clearfix" id="sign"> 
        <div class="container">
    ...
    <!-- Footer Reveal JS -->
    <script src="../build/js/footer-reveal.min.js"></script>
    <!-- Active JS -->
    <script src="../build/js/active.js"></script>
</body>
